...
@section('content')
    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-md-10">
                <strong>List Trashed Highlights</strong>
            </div>
...
$(function() {
    $('#content-table').DataTable({
        ...
        serverSide: true,
        ajax: { url : '{{ url("/api/trashedHighlight") }}'},
        columns: [
            {data: 'id' },
            {data: 'judul' },
            {data: 'modul' },
            ...
            {target:0, data: 'status',
                ...
                {   
                        return '<div class="text-center"><i style="color:red"  class="fas fa-lg fa-cloud-upload-alt"></i></div>';
                }
            },
